...
public class ClienteController {
	...
	public String add(@RequestParam("idCliente") @Nullable Integer idCliente
		...
		if (idCliente == null) {
			Cliente addCliente = new Cliente(0, cedula, nombre, apellido, direccion, telefono, correo);
			clienteDAO.add(addCliente);
		} else {
			Cliente upCliente = new Cliente(idCliente, cedula, nombre, apellido, direccion, telefono, correo);
			clienteDAO.up(upCliente);
		}
